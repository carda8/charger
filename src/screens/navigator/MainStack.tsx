  ...
  return (
    <NavigationContainer>
      <Stack.Navigator
        ...
        {/* 충전소 상세 보기 */}
        <Stack.Screen name="StationDetailMain" component={StationDetailMain} />
        {/* 충전소 상세 고장 제보 */}
        <Stack.Screen name="StationReportPage" component={StationReportPage} />
        ...
        {/* 마이페이지 앱 설정 */}
        <Stack.Screen name="MyPageConfigPage" component={MyPageConfigPage} />
        {/* 마이페이지 마이차저 설정 */}

...
const PathMain = () => {
  ...
  return (
    <>
      <SafeAreaView
        style={{...GlobalStyles.safeAreaStyle, backgroundColor: 'white'}}>
          ...
          footerComponent={() => (
            <Pressable
              ...
              <Text
                ...
                {isGoalFinish && isStartFinish ? '길안내 받기' : '도착지 설정'}
              </Text>
            </Pressable>
          )}
          index={0}
              ...
              {showStarFilter && (
                <View
                  ...
                  <Pressable
                    ...
                    style={{
                      backgroundColor: starFilter === '1' ? '#F6F6F6' : 'white',
                      height: 40,
                      justifyContent: 'center',
                      paddingLeft: 3,
                    }}>
                  ...
                  <Pressable
                    ...
                    style={{
                      justifyContent: 'center',
                      paddingLeft: 3,
                      backgroundColor: starFilter === '2' ? '#F6F6F6' : 'white',
                      height: 40,
                    }}>
                    <Text>거리순</Text>
                  </Pressable>
                  <Pressable
                    ...
                    style={{
                      justifyContent: 'center',
                      paddingLeft: 3,
                      backgroundColor: starFilter === '3' ? '#F6F6F6' : 'white',
                      height: 40,
                    }}>
                    <Text>이름순</Text>
                  </Pressable>
